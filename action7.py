...
with open('cells_new_51.json', 'r') as f:
    cells = json.load(f)

# Open the original image
image = Image.open('cell_51_with_neighbors.png')

# Grid size of the original image
grid_size = 5  # 10x10 grid

# Example: Extract the area of a specific cell and its neighbors
cell_number_to_extract = 6  # Replace with your target cell number
